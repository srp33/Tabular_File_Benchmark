...
#time python3 BuildRandomAccessMP.py /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Metadata.tsv /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Metadata.mp
#time python3 BuildRandomAccessMP.py /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Gene_Expression_small.tsv /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Gene_Expression_small.mp

#time python3 RandomlyAccessFile.py /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Metadata.mp /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Metadata.tsv /dev/null --num_samples=10000
#time python3 RandomlyAccessFile.py /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Gene_Expression_small.mp /Applications/tmp/WB_P1_L5/WishBuilder/LINCS_PhaseI_Level5/Gene_Expression_small.tsv /dev/null --num_samples=100000
