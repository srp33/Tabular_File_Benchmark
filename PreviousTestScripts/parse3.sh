...
#python3 BuildDB3.py /Applications/tmp/test.tsv /Applications/tmp/test3.db
#time python3 BuildDB3.py /Applications/tmp/Metadata.tsv /Applications/tmp/Metadata3.db
time python3 BuildDB3.py /Applications/tmp/Gene_Expression.tsv /Applications/tmp/Gene_Expression3.db

#python3 BuildDB2.py /Applications/tmp/test.tsv /Applications/tmp/test2.db
#time python3 BuildDB2.py /Applications/tmp/Metadata.tsv /Applications/tmp/Metadata2.db
...
#python3 BuildVedis.py /Applications/tmp/Gene_Expression.tsv /Applications/tmp/Gene_Expression.vedis
