...
def getDbTable(tableName):
    return SqliteDict(databasePath, autocommit=autocommit, journal_mode=journal_mode, encode=my_encode, decode=my_decode)
...
#        with open(transposedFilePath, 'w') as transposedFile:
