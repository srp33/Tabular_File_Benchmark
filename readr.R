...
data = suppressWarnings(suppressMessages(read_tsv(in_file_path, col_select=all_of(c(discrete_query_col_name, numeric_query_col_name, col_names_to_keep)), num_threads=num_threads, lazy=lazy)))
