...
tmp_tsv_file_path = "/tmp/archs4_tmp.tsv.gz"
tmp_sample_f4_file_path = "/tmp/archs4_sample_tmp.f4"
tmp_expr_f4_file_path = "/tmp/archs4_expr_tmp.f4"
tmp_expr_transposed_f4_file_path = "/tmp/archs4_expr_transposed_tmp.f4"

## Get characteristic info
#characteristics_series = {}
#with gzip.open(sample_file_path) as sample_file:
...
#    header_items = sample_file.readline().decode().rstrip("\n").split("\t")
#
#    with gzip.open(tmp_tsv_file_path, "w") as tmp_tsv_file:
...
#
#with gzip.open(expr_file_path) as expr_file:
...
#index_columns=["age", "cell line", "cell type", "tissue", "sex", "treatment"
