...
#python3 BuildDB.py /Applications/tmp/test.tsv /Applications/tmp/test2.db
#time python3 BuildDB.py /Applications/tmp/Metadata.tsv /Applications/tmp/Metadata2.db
time python3 BuildDB.py /Applications/tmp/Gene_Expression.tsv /Applications/tmp/Gene_Expression2.db
